...
const STATION_WEIGHTS: Record<Strategy, Partial<Record<string, number>>> = {
  idle: {},
  workaholic: { staff: 3, desk: 2, press: 2, phone: 2, floor: 2, brief: 2, watch: 2.5 },
  balanced: { staff: 2, press: 1.5, phone: 1, floor: 1.5, family: 2, rest: 2, brief: 1.5, watch: 2 },
  "family-first": { family: 4, rest: 3, staff: 1, watch: 1 },
};
