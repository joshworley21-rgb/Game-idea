...
import { el, meter, one, sparkline } from "../dom.ts";
import { personRow } from "../speakerView.ts";
import { band, bandLow, panel, statLine, type PanelHost } from "./host.ts";
import { familyRoster } from "./station.ts";

/** The whole state of play, including the people running the departments. */
