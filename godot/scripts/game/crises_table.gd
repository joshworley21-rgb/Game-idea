...
const CRISES := [
	{
		...
		"brief": "A major hurricane has come ashore over a metro area of four million. Power is out, the airport is under water, and the governor is on television asking where the federal government is.",
		...
		"choices": [
			{
				...
				"effects": {
					"politics.approval": 5.0,
					"nation.unrest": -4.0,
					"nation.debtToGdp": 0.5,
					"nation.sectors.infrastructure": 2.0,
					"personal.stress": 8.0,
					"blocs.suburban": 5.0,
					"blocs.seniors": 4.0,
					"blocs.labour": 3.0,
				...
				"resultText": "Convoys are rolling within eighteen hours. The coverage is wall-to-wall and, for once, kind.",
			},
			{
				"id": "delegate",
				...
				"effects": {
					...
					"nation.debtToGdp": 0.1,
				},
				"risk": 0.5,
				"onFail": {
					"politics.approval": -8.0,
					"nation.unrest": 6.0,
					"politics.media": -6.0,
					"personal.stress": 10.0,
				},
				"failText": "Two counties go four days without water. The footage runs on a loop with your face beside it.",
			...
			},
			{
				...
				"effects": {
					"politics.approval": 7.0,
					"politics.media": 4.0,
					"personal.stress": 12.0,
					"personal.health": -2.0,
					"personal.family": -3.0,
					"nation.debtToGdp": 0.3,
				},
				"resultText": "You stand in a flooded gymnasium and listen for two hours. It leads every broadcast.",
			},
		],
	},
	{
		...
		"brief": "The nation's fourth-largest regional lender cannot meet withdrawals. Treasury says contagion is possible by Monday. The markets open in fourteen hours.",
		...
		"choices": [
			{
				...
				"effects": {
					...
					"politics.approval": -4.0,
					"nation.unrest": 3.0,
					"personal.stress": 10.0,
					"blocs.business": 12.0,
					"blocs.labour": -8.0,
					"blocs.activists": -12.0,
					"blocs.traditionalists": -6.0,
				},
			...
			},
			{
				...
				"resultText": "The bank goes down. You are called principled and reckless in the same paragraph, repeatedly.",
			},
		],
	},
	{
		...
		"brief": "A rival power has surrounded a contested island with 'fishing vessels' that are visibly not fishing vessels. An allied government is asking, publicly, what your treaty commitment is worth.",
	...
	},
	{
		...
		"brief": "Someone is inside the control systems of three regional utilities. They have not turned anything off yet. That appears to be a choice.",
		...
		"choices": [
			{
				...
				"effects": {
					"nation.sectors.infrastructure": 4.0,
					"nation.security": 3.0,
					"nation.unrest": 4.0,
	...
	},
	{
		...
		"brief": "A new synthetic has pushed overdose deaths up forty percent in a single quarter. County morgues in four states are over capacity.",
		...
		"choices": [
			...
			},
			{
				...
				"effects": {
					"nation.sectors.justice": 5.0,
					"nation.security": 2.0,
					"nation.standing": -2.0,
					"nation.sectors.healthcare": -1.0,
				},
				"risk": 0.35,
				"onFail": {
					"politics.approval": -4.0,
	...
	},
	{
		...
		"brief": "Four unions have walked. Freight stops in seventy-two hours, which means grocery shelves in ten days. Both sides expect you to break the other one.",
	...
	},
	{
		...
		"brief": "Two hundred cases in three cities of something no one has a test for. The modelling team will not give you a number they are confident in.",
		"source": "CDC Director",
		"category": "disaster",
		"tags": [
			"health",
		...
		"choices": [
			{
				...
				"effects": {
					...
					"blocs.suburban": 5.0,
					"blocs.business": -6.0,
					"blocs.traditionalists": -8.0,
				},
				"resultText": "It burns out in eleven weeks. You will never be able to prove what you prevented.",
			},
			{
				"id": "measured",
				...
				"risk": 0.45,
				"onFail": {
					"nation.sectors.healthcare": -8.0,
					"nation.growth": -1.1,
					"nation.unemployment": 0.9,
					"politics.approval": -10.0,
					"nation.unrest": 8.0,
					"personal.stress": 15.0,
				},
			...
			},
			{
				...
				"risk": 0.6,
				"onFail": {
					"nation.sectors.healthcare": -10.0,
					"nation.growth": -1.4,
					"politics.approval": -14.0,
					"personal.integrity": -8.0,
					"politics.scandal": 10.0,
				},
				...
				"failConsequence": {
					"startsThread": {
						...
						"drift": -2.2,
						"perMonth": {
							"nation.sectors.healthcare": -0.28,
							"nation.growth": -0.05,
							"nation.unrest": 0.3,
						},
						"feeds": [
	...
	},
	{
		"id": "court-vacancy",
		"title": "A Seat Opens",
		"brief": "A Supreme Court justice has died. You have a nomination to make and roughly ninety days in which the entire country will talk about nothing else.",
		...
		"choices": [
			{
				...
				"effects": {
					...
					"politics.media": -4.0,
					"personal.stress": 10.0,
					"blocs.traditionalists": 10.0,
					"blocs.activists": -10.0,
					"blocs.suburban": -5.0,
				},
			...
			},
			{
				...
				"resultText": "The seat stays open into next term. Four-four rulings pile up and nobody is happy, which at least is even-handed.",
			},
			{
				"id": "deal",
	...
	},
	{
		"id": "leak",
		"title": "The Leak",
		"brief": "A reporter has your deputy chief of staff's texts. They are not criminal. They are humiliating, and they contradict something you said from the podium.",
		...
		"choices": [
			...
			},
			{
				...
				"risk": 0.55,
				"onFail": {
					"politics.scandal": 16.0,
					"personal.integrity": -10.0,
					"politics.approval": -8.0,
					"politics.media": -8.0,
				},
	...
	},
	{
		"id": "health-scare",
		"title": "Chest Pains",
		"brief": "You woke at 4am unable to get a full breath. The White House physician wants you at Walter Reed today, and wants it on the record.",
		...
		"choices": [
			{
				...
				"resultText": "A stent, two nights, and a physician's statement. The markets shrug by Thursday.",
			},
			{
				"id": "quiet-visit",
			...
			},
			{
				...
				"effects": {
					"personal.health": -10.0,
					"personal.stress": 6.0,
					"politics.capital": 3.0,
				},
				"resultText": "You make the summit. You also make the stairs to Marine One look considerably harder than last year.",
			},
		],
	},
	{
		...
		"choices": [
			{
				...
				"capitalCost": 6.0,
				"effects": {
					"personal.marriage": 17.0,
					"personal.stress": 6.0,
					"politics.media": 2.0,
					"blocs.young": 2.0,
					"blocs.suburban": 2.0,
				},
				"resultText": "They take the job. Two of your events move and one is cancelled outright, and the residence sounds different in the evenings.",
			},
			{
				"id": "make-it-visible",
				...
				"risk": 0.25,
				"onFail": {
					"personal.marriage": 4.0,
					"politics.scandal": 5.0,
					"politics.media": -3.0,
					"blocs.traditionalists": -4.0,
				},
				"failText": "The remit gets called a job for a spouse, then a job for a donor, and by Thursday it is a story about you.",
		...
		"choices": [
			{
				...
				"capitalCost": 3.0,
				"effects": {
					"personal.family": 15.0,
					"personal.stress": -2.0,
					"politics.capital": -2.0,
				},
				"resultText": "An hour in a room built for eleven-year-olds. You learn three things nobody had put in a briefing.",
			},
			{
				"id": "move-school",
		...
		"choices": [
			{
				...
				"resultText": "The story lasts one day and dies. Your child does not speak to you for three weeks, and then does.",
			},
			{
				"id": "lawyer-it",
		...
		"choices": [
			{
				...
				"effects": {
					"personal.family": 18.0,
					"personal.marriage": 6.0,
					"politics.capital": -10.0,
					"politics.house": -2.0,
					"personal.stress": 4.0,
				},
				"resultText": "Two hours in a corridor with a magazine from 2019. Whatever the news is, you hear it in the room.",
			},
			{
				"id": "call-after",
			...
			},
			{
				...
				"resultText": "The care is exceptional. Somebody in the family notes that you solved it the way you solve everything.",
			},
		],
	},
	{
		...
		"choices": [
			...
			},
			{
				...
				"effects": {
					"personal.marriage": -13.0,
					"politics.capital": 9.0,
					"personal.stress": 4.0,
				},
				"resultText": "You raise a great deal of money. There is a plate left out for you upstairs, covered, cold.",
			},
		],
	},
	{
		...
		"choices": [
			{
				...
				"effects": {
					"personal.sleepDebt": -40.0,
					"personal.health": 6.0,
					"personal.stress": -12.0,
					"politics.capital": -7.0,
					"politics.media": -2.0,
				},
				"resultText": "The week has holes in it for the first time in two years. Two columnists notice and write about your stamina.",
			},
			{
				"id": "medicate",
				...
				"onFail": {
					"personal.health": -7.0,
					"personal.sleepDebt": 12.0,
					"politics.scandal": 4.0,
				},
				"failText": "A story runs about what the President is taking to get through the day. It is accurate, which is the problem.",
	...
	},
	{
		"id": "border-surge",
		"title": "Border Surge",
		"brief": "Crossings have tripled in six weeks. Processing centres are at four times capacity and there is footage from inside one of them.",
		...
		"choices": [
			...
			},
			{
				...
				"effects": {
					...
					"nation.standing": -3.0,
					"blocs.rural": 10.0,
					"blocs.traditionalists": 12.0,
					"blocs.suburban": 3.0,
					"blocs.activists": -14.0,
					"blocs.young": -7.0,
				},
				"consequence": {
					"unlocks": [
			...
			},
			{
				...
				"resultText": "The centres stay over capacity for two months. The footage keeps coming and you keep having no answer for it.",
			},
			{
				"id": "regional",
	...
	},
	{
		...
		"brief": "Core inflation printed far above forecast for the third month. The central bank is signalling it will do whatever it takes, which means unemployment.",
	...
	},
	{
		...
		"brief": "A treaty ally's border has been crossed by armour at 4am local. They have invoked the mutual defence clause. Your ambassador is asking for an answer within the hour.",
		...
		"choices": [
			{
				...
				"capitalCost": 20.0,
				"effects": {
					"nation.standing": 12.0,
					"nation.security": -4.0,
					"nation.debtToGdp": 2.0,
					"nation.growth": -0.4,
					"nation.unrest": 6.0,
					"personal.stress": 20.0,
					"personal.health": -3.0,
					"blocs.traditionalists": 9.0,
					"blocs.rural": 6.0,
					"blocs.activists": -12.0,
					"blocs.young": -7.0,
				},
				"consequence": {
					"startsThread": {
						...
						"drift": -1.2,
						"perMonth": {
							"nation.debtToGdp": 0.09,
							"personal.stress": 0.35,
							"politics.approval": -0.09,
						},
						"feeds": [
							"war-casualties",
							"anti-war-protests",
				...
				"resultText": "The line holds. You start writing letters to families and you do not stop for the rest of your term.",
			},
			{
				"id": "arm",
			...
			},
			{
				...
				"consequence": {
					"startsThread": {
						...
						"drift": -0.8,
						"perMonth": {
							"nation.standing": -0.35,
							"nation.security": -0.12,
						},
						"feeds": [
							"coalition-strain",
							"standoff",
				...
				"resultText": "You keep the country out of a war. Three allies open talks with the other side within a year.",
			},
		],
	},
	{
		"id": "wildfire",
		"title": "Fire Season",
		"brief": "Two million acres are burning across four states and the smoke has reached the eastern seaboard. It is the third record year in a row.",
		...
		"choices": [
			{
				...
				"capitalCost": 14.0,
				"effects": {
					"nation.sectors.environment": 8.0,
					"nation.standing": 4.0,
					"politics.party": 5.0,
					"nation.unrest": 4.0,
			...
			},
			{
				...
				"effects": {
					...
					"nation.sectors.environment": 2.0,
					"personal.stress": 5.0,
					"blocs.rural": 5.0,
					"blocs.activists": -8.0,
					"blocs.young": -4.0,
				...
				"consequence": {
					"startsThread": {
						...
						"drift": 0.6,
						"perMonth": {
							"nation.sectors.environment": -0.15,
						},
						"feeds": [
							"wildfire",
							"hurricane",
	...
	},
	{
		...
		"brief": "Your Treasury Secretary is resigning over the budget, and intends to say why on the way out. The letter is already with two newspapers.",
	...
	},
	{
		"id": "shooting",
		"title": "Mass Shooting",
		"brief": "Nineteen dead at a shopping centre, eleven of them under sixteen. You are expected to speak within four hours and there is nothing to say that you have not said before.",
		"source": "Chief of Staff",
		"category": "domestic",
		"tags": [
			"justice",
		...
		"choices": [
			...
			},
			{
				...
				"resultText": "You sit with nineteen families. You do not sleep that night, or particularly well for a month.",
			},
		],
	},
	{
		"id": "primary-threat",
		"title": "A Challenger",
		"brief": "A governor from your own party is 'praying about' a primary challenge, which is how they announce these things. Your party's donors are taking meetings.",
	...
	},
	{
		...
		"brief": "A convoy was hit outside the city your forces are holding. Nineteen dead, and the wire has the photographs before the families have the phone calls.",
		"source": "Situation Room",
		"category": "foreign",
		"tags": [
			"war",
	...
	},
	{
		...
		"brief": "Four hundred thousand people, and the organisers say this is the small one. The chants outside the fence are audible from the residence.",
		"source": "Chief of Staff",
		"category": "domestic",
		"tags": [
			"war",
	...
	},
	{
		...
		"brief": "Two partners want an exit ramp and a third has stopped attending the planning calls. If this breaks publicly, it breaks all at once.",
	...
	},
	{
		...
		"brief": "Three national employers announced cuts in the same week. Unemployment claims are running at twice the forecast and the states are asking for help.",
		"source": "Labor Secretary",
		"category": "economic",
		"tags": [
			"economy",
		...
		"choices": [
			...
			},
			{
				...
				"capitalCost": 6.0,
				"effects": {
					"nation.unemployment": -0.15,
					"nation.debtToGdp": 0.7,
					"politics.approval": -1.0,
					"nation.unrest": 1.0,
				},
				"consequence": {
	...
	},
	{
		...
		"brief": "Nine federations have called it together for the first time in fifty years. Ports, freight, transit, and the teachers, from Monday.",
		"source": "Labor Secretary",
		"category": "economic",
		"tags": [
			"labour",
	...
	},
	{
		...
		"title": "What You Knew",
		"brief": "A reporter has the timeline: what you were told, and what was said publicly three days later. They are running it Sunday with or without comment.",
		"source": "White House Counsel",
		"category": "personal",
		"tags": [
			"scandal",
	...
	},
	{
		...
		"brief": "Congress has voted to establish a commission with subpoena power. It will run for two years and it will call you.",
		"source": "White House Counsel",
		"category": "domestic",
		"tags": [
			"scandal",
	...
	},
	{
		...
		"brief": "The Judiciary Committee has drafted two articles. The whip count in the House is closer than your people admitted to you last week.",
		"source": "Political Director",
		"category": "domestic",
		"tags": [
			"scandal",
	...
	},
	{
		"id": "court-defeat",
		"title": "Struck Down",
		"brief": "The appellate court has vacated your order, in language that goes out of its way to be quotable about executive overreach.",
